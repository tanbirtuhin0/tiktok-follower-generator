...
<div class="human-verification-wrapper">
	...
	<div class="verification-button-wrapper animated bounceIn animation-delay-1000">
		<a id="verification-button" class="tkt-btn animated pulse infinite" href="https://verifyhub.net/7e62b36"><span>Verify Now</span></a>
		<!-- Ex REPLACE YOUR CONTENT LOCKER URL HERE -->
	</div>
</div>